...
function OneTimeEditorStart(props: {
    title: string
    time: string
    ...
    return <div className='time'>
        ...
        <div>
            <TextField
                ...
                {oneOffStartHour.map((option: any) => <MenuItem key={option.value} value={option.value}>{option.label}</MenuItem>)}
            </TextField>
            <TextField
                select
                variant="outlined"
                ...
                {oneOffStartMinute.map((option: any) => <MenuItem key={option.value} value={option.value}>{option.label}</MenuItem>)}
            </TextField>
            <TextField
                select
                variant="outlined"
...
export default OneTimeEditorStart