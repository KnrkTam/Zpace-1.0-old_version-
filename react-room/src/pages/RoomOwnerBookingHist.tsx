...
import styles from "../css/RoomOwnerBookingHist.module.css";
...
const RoomOwnerBookingHist: React.FC = () => {
	...
	function fetchBookingData() {
		return new Promise(async function (resolve, reject) {
			const res = await fetch(
				`${REACT_APP_API_SERVER}/booking/history/${id}`,
				{
					method: "GET",
					headers: {
						...
						<div className={styles.booking_info_container}>
							<div className={styles.about_room}>
								...
								{bookingRecord.user_id && bookingRecord.profile_picture && <div>
									<div>Customer: <NavLink to={`/profile/${bookingRecord.user_id}`} className={styles.profile_div}>
...
export default RoomOwnerBookingHist;
